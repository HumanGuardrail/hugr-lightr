...
use super::{
    ...
    ETHERTYPE_IPV4, ETH_HDR_LEN, GATEWAY_MAC, HLEN_ETHERNET, HTYPE_ETHERNET, IP_PROTO_UDP,
    IPV4_MIN_HDR_LEN, IPV4_MIN_IHL_WORDS, DHCP_MAGIC_COOKIE, LEASE_SECS, OPT_DNS, OPT_END,
    OPT_LEASE_TIME, OPT_MESSAGE_TYPE, OPT_ROUTER, OPT_SERVER_ID, OPT_SUBNET_MASK,
    UDP_HDR_LEN, DHCP_CLIENT_PORT, DHCP_SERVER_PORT,
};
